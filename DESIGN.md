...
현재 프론트엔드는 화이트 `#ffffff`, 블루 `#2864ed`, 본문 `#192638`를 사용한다. 최종 브랜드 컬러 확정은 별도이며, 초기 grayscale wireframe에서 밝은 전시 키오스크 시안으로 전환했다.
...
- 800×1280 원본 기준 본문 28px, 보조 안내 24px, 제목 52px, 홈 제목 64px.
...
현재 시안 구성:
- 홈은 짧은 중앙 제목, 컬러 사원증 예시, 블루 입사 버튼과 흰색 퇴근 버튼을 사용한다.
